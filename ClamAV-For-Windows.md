...
| **8** | Show that the 'Scheduled Task' was created by running this command on Powershell: `Get-ScheduledTask` It should be the very first result. Take a screenshot. |
