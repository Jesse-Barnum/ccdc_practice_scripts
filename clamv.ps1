...
schtasks /create /tn "Clam_30min_scan" /tr " \"C:\Program Files\ClamAV\clamscan.exe\" -r -i --log=\"C:\temp\System_scan.log\" \"C:\Windows\System32\" " /sc minute /mo 30 /ru System /rl highest /f
